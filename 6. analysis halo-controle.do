...
use "C:\Users\Public\Documents\AbedMeraim_Mongruel\base_imputee.dta"
				...
				*** ANALYSIS : DID FOR CONTROL & HALO GROUPS ***
...
outreg2 using halo_parallele_cadre, tex
...
outreg2 using halo_xtdidreg_cadre, tex title(Diff-in-diff : share of female managers)
...
outreg2 using halo_xtdidreg_cadre_cov, tex title(Diff-in-diff : share of female managers)
...
estat granger 
estout using halo_parallele_cadre.tex, replace 
eststo clear
...
margins treated, dydx(annee)
outreg2 using halo_parallele_cadre_dir, tex

* III.2. ESTIMATION  *

* DiD regression on panel data without controls *
xtdidreg (prop_cadre_dir_f) (did), group(siren) time(annee)
outreg2 using halo_xtdidreg_cadre_dir, tex title(Diff-in-diff : share of female executive manager)

* DiD regression on panel data with controls *
xtdidreg (prop_cadre_dir_f type eff eff_squared tr_ca s_brut_moy annee_crea reg_siege) (did), group(siren) time(annee)
outreg2 using halo_xtdidreg_cadre_dir_cov, tex
...
* Granger type causality test *
estat granger 
estout using halo_parallele_cadre_dir.tex, replace 
eststo clear
...
margins treated, dydx(annee)
outreg2 using halo_parallele_partiel_cadre, tex

* IV.2. ESTIMATION  *

* DiD regression on panel data without controls *
xtdidreg (prop_partiel_cadre_f) (did), group(siren) time(annee)
outreg2 using halo_xtdidreg_partiel_cadre, tex title(Diff-in-diff : share of female part-time manager)

* DiD regression on panel data with controls *
xtdidreg (prop_partiel_cadre_f type eff eff_squared tr_ca s_brut_moy annee_crea reg_siege) (did), group(siren) time(annee)
outreg2 using halo_xtdidreg_partiel_cadre_cov, tex
...
* Granger type causality test *
estat granger 
estout using halo_parallele_partiel_cadre.tex, replace 
eststo clear
...
margins treated, dydx(annee)
outreg2 using halo_parallele_part_cadre, tex

* V.2. ESTIMATION *

* DiD regression on panel data without controls *
xtdidreg (part_cadre_f) (did), group(siren) time(annee)
outreg2 using halo_xtdidreg_part_cadre, tex title(Diff-in-diff)
...
outreg2 using halo_xtdidreg_part_cadre_cov, tex
...
* Granger type causality test *
estat granger 
estout using halo_parallele_part_cadre.tex, replace 
eststo clear
...
margins treated, dydx(annee)
outreg2 using halo_parallele_part_cadre_dir, tex

* VI.2. ESTIMATION *

* DiD regression on panel data without controls *
xtdidreg (part_cadre_dir_f) (did), group(siren) time(annee)
outreg2 using halo_xtdidreg_part_cadre_dir, tex title(Diff-in-diff)
...
outreg2 using halo_xtdidreg_part_cadre_dir_cov, tex
...
* Granger type causality test *
estat granger 
estout using halo_parallele_part_cadre_dir.tex, replace 
eststo clear
...
outreg2 using halo_xtdidreg_wage_f_cadre, tex title(Diff-in-diff)
* Display pretrend evolution : observed means and linear trends *
estat trendplot
* Parallel-trends test *
estat ptrends
* Granger type causality test *
estat granger 
estout using halo_parallele_wage_f_cadre.tex, replace 
eststo clear

* Men *
xtdidreg (s_brut_moy_h_cadre type eff tr_ca eff_squared s_brut_moy annee_crea reg_siege) (did), group(siren) time(annee)
outreg2 using halo_xtdidreg_wage_h_cadre, tex title(Diff-in-diff)
* Display pretrend evolution : observed means and linear trends *
estat trendplot
* Parallel-trends test *
estat ptrends
* Granger type causality test *
estat granger 
estout using halo_parallele_wage_h_cadre.tex, replace 
eststo clear

* Gap *
xtdidreg (s_brut_moy_gap_cadre type eff tr_ca eff_squared s_brut_moy annee_crea reg_siege) (did), group(siren) time(annee)
outreg2 using halo_xtdidreg_wage_gap_cadre, tex title(Diff-in-diff)
* Display pretrend evolution : observed means and linear trends *
estat trendplot
* Parallel-trends test *
estat ptrends
* Granger type causality test *
estat granger 
estout using halo_parallele_wage_gap_cadre.tex, replace 
eststo clear
